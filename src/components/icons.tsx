...
export function KanpaiIcon({ className = '', size = 24 }: IconProps) {
  return (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M7.5 3.5L10 10a3 3 0 0 1-1.8 3.8L7 14.2 4.6 5z" />
      <path d="M16.5 3.5L14 10a3 3 0 0 0 1.8 3.8l1.2.4L19.4 5z" />
      <path d="M7 14.2L5.5 20M17 14.2l1.5 5.8" />
      <path d="M3.5 20.5h5M15.5 20.5h5" />
    </svg>
  );
}

export function CircleCropIcon({ className = '', size = 24 }: IconProps) {
  return (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <circle cx="12" cy="12" r="9" />
      <circle cx="12" cy="12" r="4.2" strokeDasharray="2.4 2.6" />
    </svg>
  );
}
...
export function MegaphoneIcon({ className = '', size = 24 }: IconProps) {
  return (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M4 13.5v-3l11-5v13z" />
      <path d="M15 8.5c2 .6 3.5 1.9 3.5 3.5S17 15 15 15.5" />
      <path d="M7 14v4.5a1.5 1.5 0 0 0 3 0V14" />
    </svg>
  );
}

export function MessagePlusIcon({ className = '', size = 24 }: IconProps) {
  return (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M4 7a3 3 0 0 1 3-3h10a3 3 0 0 1 3 3v6a3 3 0 0 1-3 3h-6l-4.5 4v-4H7a3 3 0 0 1-3-3z" />
...
export function MapPinIcon({ className = '', size = 24 }: IconProps) {
  return (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M12 21c-4-4.5-6-7.8-6-10.5a6 6 0 1 1 12 0c0 2.7-2 6-6 10.5z" />
...
export function DiamondIcon({ className = '', size = 24 }: IconProps) {
  return (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M3 10h18M12 19.5L8.5 10l2-5.5M12 19.5L15.5 10l-2-5.5" />
    </svg>
  );
}
...
export function GroupIcon({ className = '', size = 24 }: IconProps) {
  return (
    <svg className={className} width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      ...
      <path d="M17.5 14.9c1.6.7 2.7 2 3.2 4.1" />
    </svg>
  );
}
