...
\`\`\`
■イベント・オフ会内容
（会の紹介: 挨拶・自己紹介・どんな会か・こんな人に来てほしい・日時・場所・定員を、このセクション内に読みやすくまとめる。挨拶と自己紹介は1〜2文で初主催であることを正直に親しみやすく、どんな会かは目的・大切にしたいことを自然な文章で、こんな人に来てほしいはペルソナをやわらかい表現で、開催概要は日時・場所・定員を見やすくまとめる。場所は「基本情報」で入力された内容（オフィス名・エリア名等）以上に詳細な住所・地図リンク・店名などを書き足さないこと（不特定多数が見る公開情報のため、詳細な待ち合わせ場所は書かない）。当日の流れ・タイムテーブルはここに書かないこと）
